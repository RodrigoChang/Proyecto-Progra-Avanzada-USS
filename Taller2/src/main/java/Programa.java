...
public class Programa {
    public static void main(String[] args){
        ...
        Controlador controlador = new Controlador(login,ventana_login,ventana_principal,ventana_alta_usuario,ventana_principal_admin, ventana_principal_alumno,ventana_principal_profesor);
